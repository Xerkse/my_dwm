...
static const double inactiveopacity =
    0.9f; /* Window opacity when it's inactive (0 <= opacity <= 1) */
...
static const char *fonts[] = {"mononoki:size=15", "monospace:size=15"};
...
static const Layout layouts[] = {
    ...
    {"><>", NULL},
    /*13*/ /* no layout function means floating behavior */
    {NULL, NULL},
...
static Key keys[] = {
    ...
    {0,
     XK_mute,
     spawn,
     {.v = (const char *[]){"pulsemixer", "--toggle-mute", NULL}}},
    {0,
     XK_volumeDown,
     spawn,
     {.v = (const char *[]){"pulsemixer", "--change-volume", "-2", NULL}}},
    {0,
     XK_volumeUp,
     spawn,
     {.v = (const char *[]){"pulsemixer", "--change-volume", "+2", NULL}}},
    {0,
     XK_micMute,
     spawn,
     {.v = (const char *[]){"pulsemixer", "--id", "source-1", "--toggle-mute",
                            NULL}}},
    {0,
     XK_brightDown,
     spawn,
     {.v = (const char *[]){"brightnessctl", "s", "50-", NULL}}},
    {0,
     XK_brightUp,
     spawn,
     {.v = (const char *[]){"brightnessctl", "s", "50+", NULL}}},
    ...
    {MODKEY | ShiftMask,
     XK_e,
     spawn,
     {.v = (const char *[]){"stop_read_clipboard", NULL}}},
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3)
        TAGKEYS(XK_5, 4){MODKEY, XK_p, spawn, SHCMD("slock")},
    ...
    {MODKEY | ControlMask | ShiftMask,
     XK_p,
     spawn,
     {.v = (const char *[]){"gpg-connect-agent", "reloadagent", "/bye", NULL}}},
};
